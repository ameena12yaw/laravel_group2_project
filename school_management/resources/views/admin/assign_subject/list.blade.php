                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ Request::get('name') }}" name="cname"  placeholder="Class Name">
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Subject Name</label>
                                    <input type="text" class="form-control" value="{{ Request::get('name') }}" name="sname"  placeholder="Subject Name">
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Date</label>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <a href="{{ url('admin/class/list') }}" class="btn btn-info" style="margin-top: 30px">Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
